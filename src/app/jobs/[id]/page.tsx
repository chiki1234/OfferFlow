  ...
  return <main className="page-stack">
    ...
    <div className="detail-layout">
      <div className="detail-main">
        <section className="surface-card detail-section"><div className="section-title-row"><div><p className="eyebrow">岗位上下文</p><h2>JD</h2></div><FileText size={20} /></div><p className="jd-copy">{view.jobTrack.jobDescription || "还没有补充 JD。"}</p><JobContextEditor jobTrack={view.jobTrack} token={randomUUID()} /></section>
      ...
      <aside className="surface-card form-panel detail-actions"><JobActionsPanel jobTrackId={id} lifecycle={view.jobTrack.lifecycle} resumes={view.resumes} tokens={{ submit: randomUUID(), assessment: randomUUID(), interview: randomUUID(), resume: randomUUID(), task: randomUUID(), rejection: randomUUID(), end: randomUUID(), progress: randomUUID(), delete: randomUUID() }} /></aside>
    </div>
  </main>;
}
